...
function use(){ //아이디중복확인 사용을 눌렀을시 그대로 입력받을수있게할수있는 함수
	opener.frm_sign.email.value = '<%=email%>';
	opener.frm_sign.chEMAIL.value = 'y';
	opener.document.getElementById("email_span").innerHTML = "<p class='text-success'><span class='glyphicon glyphicon-ok'></span></p>";
